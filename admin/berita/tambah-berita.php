				...
				<form method="POST" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-lg-6 mt-3">
							...
							<p class="text-danger mt-1" style="font-size: 12px;">Ekstensi File yang di perbolehkan : jpg, png max. 5MB</p>
							<input type="hidden" name="tanggal" value="<?php echo date("Y-m-d"); ?>">
						</div>
						<div class="col-lg-12">
							<textarea class="form-control" id="summernote" name="artikel" rows="10"></textarea>
						</div>
