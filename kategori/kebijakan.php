<?php 
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_kebijakan order by id DESC");
 ...
 <div class="container">
        <div class="text-center mb-4 mt-4">
			...
			<br>
			<embed type="application/pdf" src="assets/file/pdf/kebijakan/<?= $dokumen['pdf'] ?>" style="width: 100%; height: 100vh;"></embed>
